#######################################################################################################
# Training the Artificial Word Learning (awl) model - oral language training and Reading training
# Executable files : awl_pretraining and aoa_reading
# Parameters: 
...
./awl_evaluator -key exp_jo_taylor_set1.txt -patterns ps_randcon_awl.pat -semantic -weights ../TrainedWeights/Oral/LP/PS_Weight_LP_v1 > PS_LP_v1.txt

e.g. for speaking (SP)
./awl_evaluator -key exp_jo_taylor_set1.txt -patterns sp_awl.pat -weights ../TrainedWeights/Oral/LP/SP_Weight_LP_v1 > SP_LP_v1.txt

e.g. for word comprehension (OS)
./awl_evaluator -key exp_jo_taylor_set1.txt -patterns englishdict_randcon_awl.pat -semantic -weights ../TrainedWeights/Reading/LP/OP/OP_Reading_Weight_LP_v1_t1000 > OP_focused_OS_LP_v1.txt

e.g. for word naming (OP)
./awl_evaluator -key exp_jo_taylor_set1.txt -patterns englishdict_randcon_awl.pat -weights ../TrainedWeights/Reading/LP/OP/OP_Reading_Weight_LP_v1_t1000 > OP_focused_OP_LP_v1.txt
